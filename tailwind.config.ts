		...
		extend: {
			colors: {
				...
				category: {
					...
					pastoral: 'hsl(var(--category-pastoral))',
					esportes: 'hsl(var(--category-esportes))',
					robotica: 'hsl(var(--category-robotica))',
					biblioteca: 'hsl(var(--category-biblioteca))',
					nap: 'hsl(var(--category-nap))'
				}
			},
			backgroundImage: {
			...
			animation: {
				...
				'bounce-subtle': 'bounce 1s ease-out',
